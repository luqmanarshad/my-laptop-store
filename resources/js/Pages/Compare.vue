    ...
    <MainLayout>
        <section class="container py-5">
            <div class="text-center mb-5">
                <h1 class="h2">Compare Laptops</h1>
                <p class="text-muted">Compare your selected laptops side by side.</p>
            </div>

            <div v-if="!products.length" class="text-center py-5">
                <p class="text-muted mb-3">Your compare list is empty.</p>
...
const loadProducts = () => {
    products.value = loadList('compare')
}

const removeProduct = (id) => {
    removeItem('compare', id)
    loadProducts()
}
